...
/obj/item/roguekey/lord/proc/anti_stall()
	src.visible_message(span_warning("The Key of Scarlet Reach crumbles to dust, the ashes spiriting away in the direction of the Keep."))
...
/obj/item/roguekey/sheriff
	name = "Marshal's key"
	desc = "This key belongs to the marshal of the garrison."
	icon_state = "cheesekey"
	lockid = "sheriff"
